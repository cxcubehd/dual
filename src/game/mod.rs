...
const BASE_SENSITIVITY: f64 = 0.022_f64.to_radians();
const MOUSE_SENSITIVITY: f64 = 0.3;
...
impl GameState {
    ...
    fn process_mouse_look(&mut self) {
        ...
        if dx != 0.0 || dy != 0.0 {
            self.camera.rotate(
                dx * BASE_SENSITIVITY * MOUSE_SENSITIVITY,
                -dy * BASE_SENSITIVITY * MOUSE_SENSITIVITY,
            );
        }
    }
